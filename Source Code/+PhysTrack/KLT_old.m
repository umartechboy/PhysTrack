function [trajectories, vr2o_new] = KLT_old(vr2o, objs, previewDownSample, nouserquestion)
...
if  size(objs, 1) == 1
    [trajectories, vr2o_new] = PhysTrack.KLT_SP(vr2o, objs, previewDownSample, nouserquestion);
    return;
end
    warning off;
