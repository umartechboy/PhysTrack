...
objA = PhysTrack.StitchObjectToPoints([cenA; [cenA(1), cenA(2) + radA]], trPt_.tp1, trPt_.tp2);
objB = PhysTrack.StitchObjectToPoints([cenB; [cenB(1), cenB(2) + radB]], trPt_.tp3, trPt_.tp4);
...
trajectories = PhysTrack.TransformCart2Cart(trPt_, rwRCS);
